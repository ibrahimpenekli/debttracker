		...
		<div class="row">
            <div class="span8 offset2">
            	<div class="toolbar">
                    ...
                    <a class="button default" href="{{ URL::action('UsersController@getAddPurchasedItem') }}"><i class="icon-basket on-left"></i>Add Purchased Item</a>
                    <a class="button default" href="{{ URL::action('UsersController@getAddDebt') }}"><i class="icon-dollar-2 on-left"></i>Add Debt</a>
